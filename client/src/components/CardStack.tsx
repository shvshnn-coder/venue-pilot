...
export default function CardStack({ items: initialItems, type, onSwipe }: CardStackProps) {
  ...
  return (
    <div className="flex-grow relative" data-testid="container-card-stack" onPointerDown={() => setIsDragging(true)} onPointerUp={() => setIsDragging(false)} onPointerCancel={() => setIsDragging(false)}>
